...
$query = "SELECT * FROM prospects ORDER BY id ASC";
 ...
 <main class="flex-1 md:ml-64 px-4 transition-all">
  ...
  <div class="w-full mt-3 md:mt-0">
        <p>
          ...
          <span id="totalCount">0</span> prospects
        </p>
</div>
...
<table id="shippingManifestTable" class="table-x-auto w-full text-sm text-left text-gray-700 border border-gray-200 rounded-lg overflow-hidden shadow-sm">
    <thead class="bg-gray-700 text-white uppercase text-xs font-semibold border-b border-gray-300">
        <tr>
            ...
            <th class="py-3 px-4 min-w-[160px]">Prospect Name</th>
            <th class="py-3 px-4 min-w-[180px]">Email</th>
            <th class="py-3 px-4 min-w-[160px]">Phone Number</th>
            <th class="py-3 px-4 min-w-[130px]">Message</th>
            <th class="py-3 px-4 min-w-[120px]">Sent At</th>
        </tr>
    </thead>
    <tbody class="divide-y divide-gray-200">
       <?php if (empty($shipments)): ?>
        ...
        <tr class="even:bg-gray-50 hover:bg-gray-100 transition duration-200">
            <td class="py-2 px-4"><?= htmlspecialchars($manifest['id']) ?></td> 
        <td class="py-2 px-4"><?= htmlspecialchars($manifest['fullName']) ?></td>
            <td class="py-2 px-4"><?= htmlspecialchars($manifest['email']) ?></td>
            <td class="py-2 px-4"><?= htmlspecialchars($manifest['phone_number']) ?></td>
            <td class="py-2 px-4"><?= htmlspecialchars($manifest['message']) ?></td>
            <td class="py-2 px-4"><?= htmlspecialchars($manifest['sent_at']) ?></td>
        </tr>
        <?php endforeach; ?>
        <?php endif; ?>
    </tbody>
